...
git clone https://github.com/LOV/LOV.git
cd LOV
chmod +x linuxLOV.sh
./linuxLOV.sh --build
...
git clone https://github.com/LOV/LOV.git
cd LOV
chmod +x linuxLOV64.sh
./linux64LOV.sh --build

Options:
--reset: update dependencies, clone LOV repository
--force: if you are using other versions such as Debian version > 7

Example with options:
./linux64LOV.sh --reset --force --build

After successful build, LOVd can be found in LOV/src/

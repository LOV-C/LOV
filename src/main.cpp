...
#if defined(NDEBUG)
# error "LOV cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "LOV Signed Message:\n";
...
if(pindexBest->nHeight+1 >= 1 && pindexBest->nHeight+1 <= 100)
        {
            nSubsidy = 9999.99 * COIN; // 999,999 coins
        }
...
{
    int64_t nSubsidy;
// condition removed to maintain stake %
